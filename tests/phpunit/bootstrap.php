...
function _manually_load_plugin() {
	...
	require $plugin_dir . 'b2binpay-payments-for-woocommerce/b2binpay-payments-for-woocommerce.php';
}
...
$wc_base_dir                 = dirname( dirname( dirname( __FILE__ ) ) ) . '/woocommerce/tests/';
$wc_tests_framework_base_dir = $wc_base_dir . 'framework/';

require_once( $wc_base_dir . 'includes/wp-http-testcase.php' );
