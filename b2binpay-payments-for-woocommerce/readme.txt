...
1. B2BinPay settings in WooCommerce Payments.
2. B2BinPay Payment Method on Store Front.
3. B2BinPay new invoice page.
4. A new bill in B2BinPay admin page.
5. Order notes in WordPress admin page.
